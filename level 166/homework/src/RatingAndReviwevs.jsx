    ...
    return (
        ...
        <div className='w-full flex flex-col items-center mt-[50px]'>
            <div className='flex justify-center'>
                <section className='border-b border-[#0000001A] w-[418px] flex justify-center items-center pb-[10px]'>
                    <h1 className='text-[20px] text-[#00000099] font-[400]'>Product Details</h1>
                </section>
                <section className='border-b border-[#000] w-[418px] flex justify-center items-center pb-[10px]'>
            ...
            <div className='flex justify-center w-full gap-[730px] mt-[25px]'>
                <section>
                    <h1 className='text-[24px] font-[700]'>All Reviews <span className='font-[400] text-[16px] text-[#00000099]'>(451)</span></h1>
                </section>
